...
const Login = ({ isUserAuthenticated }) => {
    ...
    return (
         ...
         <Box>
            <Main>Unlock Your Heart: A Sanctuary for Expressing Every Emotion.</Main> 
            
        <Component style={{ backgroundImage:`url(${image})`,backgroundRepeat:"no-repeat",backgroundSize:"contain" }}>
